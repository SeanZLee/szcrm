#namespace("crm.leads")
    #sql("getLeadsPageList")
      select a.leads_id,a.leads_name,b.realname as ownerUserName from 72crm_crm_leads as a left join 72crm_admin_user as b on a.owner_user_id = b.user_id where 1=1
      #if(leadsName)
