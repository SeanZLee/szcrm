...
public class AdminRoleService {
    ...
    public JSONObject auth(Long userId) {
        ...
        if (roleIds.contains(BaseUtil.getSuperRole())) {
        ...
        for (AdminMenu adminMenu : adminMenus) {
            ...
            if (adminMenu.getMenuId().equals(3)) {
                if (roleIds.contains(2) || roleIds.contains(BaseUtil.getSuperRole())) {
                ...
                if (roleIds.contains(3) || roleIds.contains(BaseUtil.getSuperRole())) {
                    object.put("user", true);
                }
                if (roleIds.contains(4) || roleIds.contains(BaseUtil.getSuperRole())) {
                    object.put("examineFlow", true);
                }
                if (roleIds.contains(5) || roleIds.contains(BaseUtil.getSuperRole())) {
                    object.put("oa", true);
                }
                if (roleIds.contains(6) || roleIds.contains(BaseUtil.getSuperRole())) {
                    object.put("crm", true);
                }
            }
            if (!object.isEmpty()) {
    ...
    public R unbindingUser(AdminUserRole adminUserRole) {
        if (BaseUtil.isSuperUser(adminUserRole.getUserId())) {
