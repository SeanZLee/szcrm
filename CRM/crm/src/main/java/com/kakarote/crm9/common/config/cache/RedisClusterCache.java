...
public class RedisClusterCache {
    ...
    protected static String defaultName="main";
    public RedisClusterCache(JedisCluster jedisCluster) {
            this(RedisClusterCache.defaultName,jedisCluster, FstSerializer.me, IKeyNamingPolicy.defaultKeyNamingPolicy);
    }

    public RedisClusterCache(String name, JedisCluster jedisCluster, ISerializer serializer, IKeyNamingPolicy keyNamingPolicy) {
        this.name = name;
    ...
    public Long getCounter(Object key) {
        JedisCluster jedisCluster = getJedisCluster();
        try {
            String ret = (String)jedisCluster.get(keyNamingPolicy.getKeyName(key));
